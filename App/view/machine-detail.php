...
<head>
    ...
    <title>Maquina de Teste de Mangueira de Incêndio</title>
</head>
...
<body>
    ...
    <main>
        ...
        <div class="product-details">
            <h1>Maquina de Teste de Mangueira de Incêndio</h1>
            <div class="product">
                <img src="<?= ASSETS_DIR ?>img/machine.jpg" alt="Produto">
                <div class="details">
                    <p>
                        As máquinas de teste de mangueira de incêndio são equipamentos projetados para verificar e
                        garantir a qualidade e a segurança das mangueiras utilizadas nos sistemas de combate a
                        incêndios.
                    </p>
